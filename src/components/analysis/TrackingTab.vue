...
// Tracking tab — gyro vs setpoint headline panel, the M-Coupling
// cross-axis matrix, and the M2 PIDFS contribution panel stacked
// vertically, all full-width. The design
