# `blackbox-log` CHANGELOG (upstream snapshot)

> Snapshot captured 2026-05-15 from commit `8ad704f1936b6f738dbe93246d1d3da2a82eed11` (upstream `main`).
> Refresh when bumping the crate version in `crates/wingtune-parser/Cargo.toml`.

## [Unreleased]

(empty at snapshot time — see upstream `main` for any drift since)
